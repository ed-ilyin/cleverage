...
let события = [
    ...
    "🐙", ПолучилКлючНе (Демон, "🐙")
    // кто-то получил ТЗ. Аватар?
    "А", ПризналсяЧтоНе Рептилоид
    "♟", ГолосуетПротив "🤬"
    "🤬", ГолосуетПротив "Х"
    "👶", ГолосуетПротив "🤬"
    "🐙", ГолосуетПротив "Х"
    ...
    "Х", ГолосуетПротив "🌈"
    // кто-то получил ТЗ.
    "А", ПорабощёнНе Рептилоид
    "🍑", ПорабощёнНе Демон
    "👣", ПризналсяЧтоНе Демон // УБЕРИ
    "👣", ПолучилКлючНе (Демон, "Х") // УБЕРИ
    "🤥", ПризналсяЧтоНе Рептилоид
    "🌈", ПризналсяЧтоНе Рептилоид
    "🐙", ГолосуетПротив "👶"
]
// Попросил таблицу, потом из-за неё и нападал на меня,
//    хотя и так ясно что таблица субъективная
// Сталкер либо реально тупит, либо специально что бы всех запутать,
//  делал вид что не понимал моих простых ответов, почему я стал против него.
// Да потому что большинство Масонов против него было
// А Аватар лоханулся - поверил Сталкеру
